...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "NerdFontMono-Regular:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
*/
	...
	{ MODKEY,			XK_Return,     spawn,                  SHCMD("/home/blue/.local/bin/alacritty-here.sh") },
